      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Box sx={{ pt: 6, pb: 4, textAlign: "center" }}>
          <Fade in timeout={1000}>
            <Box>
              ...
              >
                Build beautiful, interactive forms with our intuitive drag-and-drop builder
              </Typography>
            </Box>
          </Fade>
                    ...
                    <Fade in timeout={1600 + index * 100}>
                      <Card
                        sx={{
                          ...
                          cursor: "pointer",
                          borderRadius: 4,
                          border: newFieldType === fieldType.value ? 
                            `3px solid ${fieldType.color}` : 
                            "3px solid transparent",
                          background: newFieldType === fieldType.value ?
                            `${fieldType.gradient}` :
                            "linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%)",
                          boxShadow: newFieldType === fieldType.value ?
                            `0 8px 32px ${fieldType.color}40` :
                            "0 4px 20px rgba(0,0,0,0.08)",
                          transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                          transform: newFieldType === fieldType.value ? "translateY(-4px)" : "translateY(0)",
                          "&:hover": {
                        ...
                        >
                          ...
                          >
                            {React.cloneElement(fieldType.icon, {
                              sx: {
                                fontSize: 28,
                                color: newFieldType === fieldType.value ? "white" : "white"
                              }
                            })}
                          </Avatar>
                          <Typography
                            ...
                            sx={{
                              fontWeight: 600,
                              mb: 1,
                              color: newFieldType === fieldType.value ? "white" : "text.primary",
                              textAlign: "center",
                            }}
                          >
                            {fieldType.label}
                          ...
                          <Typography
                            variant="body2"
                            sx={{
                              color: newFieldType === fieldType.value ? 
              ...
              <Box sx={{ textAlign: "center" }}>
                <Button
                  ...
                  sx={{
                    ...
                    fontSize: "1.1rem",
                    fontWeight: 600,
                    background: fieldTypes.find(ft => ft.value === newFieldType)?.gradient || 
                      "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
                    boxShadow: `0 6px 24px ${fieldTypes.find(ft => ft.value === newFieldType)?.color || '#667eea'}40`,
                    "&:hover": {
                      boxShadow: `0 8px 32px ${fieldTypes.find(ft => ft.value === newFieldType)?.color || '#667eea'}60`,
                      transform: "translateY(-2px)",
                    }
                  }}
                >
                  Add {fieldTypes.find(ft => ft.value === newFieldType)?.label} Field
                </Button>
              </Box>
            </Paper>
          </Box>
        ...
        {fields.length > 0 ? (
          <Box sx={{ mb: 4 }}>
            ...
            {fields.map((f, idx) => {
              const fieldTypeData = fieldTypes.find(ft => ft.value === f.type);
              return (
                <Fade in timeout={800 + idx * 100} key={f.id}>
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        background: fieldTypeData?.gradient || "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
                        p: 3,
                        color: "white",
                        position: "relative",
                        "&::before": {
                    ...
                    >
                      ...
                      >
                        <Stack direction="row" spacing={2} alignItems="center">
                          ...
                          >
                            {fieldTypeData?.icon && React.cloneElement(fieldTypeData.icon, {
                          ...
                          <Box>
                            ...
                            <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.8)" }}>
                              {fieldTypeData?.description || f.type.toUpperCase()}
                            </Typography>
                          </Box>
                        </Stack>
                          ...
                          <Tooltip title="Move up">
                            <span>
                              <IconButton
                                ...
                                disabled={idx === 0}
                                sx={{
                                  color: idx === 0 ? "rgba(255,255,255,0.3)" : "rgba(255,255,255,0.8)",
                                  "&:hover": {
                                    color: "white",
                                    background: "rgba(255,255,255,0.1)",
                                  }
                          ...
                          <Tooltip title="Move down">
                            <span>
                              <IconButton
                                ...
                                sx={{
                                  color: idx === fields.length - 1 ? "rgba(255,255,255,0.3)" : "rgba(255,255,255,0.8)",
                                  "&:hover": {
                                    color: "white",
                                    background: "rgba(255,255,255,0.1)",
                                  }
                            ...
                            <FormControlLabel
                              control={
                                <Checkbox
                                  ...
                                  sx={{
                                    color: fieldTypeData?.color || "primary.main",
                                    "&.Mui-checked": {
                                      color: fieldTypeData?.color || "primary.main",
                                    }
                                  }}
                          ...
                          >
                            ...
                            <Stack spacing={2}>
                              ...
                              <FormControlLabel
                                ...
                                label={
                                  <Typography variant="body2" fontWeight={500}>
                                    Password Rule: min 8 chars, must contain a number
                                  </Typography>
                                }
                              />
                            </Stack>
